...
export const test1 = new Test("Less than (or equal to)", expect => {
    ...
    expect(1).named("1 <= 2").toBeLessThanOrEqualTo(2);
    expect(1).named("1 <= 1").toBeLessThanOrEqualTo(2);
});

export const test2 = new Test("Greater than (or equal to)", expect => {
    expect(2).named("2 > 1").toBeGreaterThan(1);
    expect(2).named("2 >= 1").toBeGreaterThanOrEqualTo(1);
    expect(1).named("1 >= 1").toBeGreaterThanOrEqualTo(1);
});
